...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create Workouts
        workouts = [
            Workout(name='Super Strength', description='Strength training for heroes', difficulty='Hard'),
            Workout(name='Agility Training', description='Improve agility and reflexes', difficulty='Medium'),
        ]
        ...
        Activity.objects.create(user=spiderman, type='Web Swinging', duration=60, date=date.today())
